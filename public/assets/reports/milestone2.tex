...
schedule our application development.
...
None of the member on our team are trained designers. We had to be resourceful
...
set of values. Although at first glance, it may seem that this restriction would our capabilities
in the design. In fact, the restriction provided by the design system helped to make
...
We describe our app as a modular, dashboard user interface that lets user's use a
