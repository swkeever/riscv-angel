...
function elfRunNextInst(command) {
    var instVal;
    var stopCount = 10000;
    var tryCount = 0;

    if (command != null && command[0] === 'l') {
        console.log("entered nextinstr");
    }
            ...
            if (readTest.length) {
                ...
                if (tryCount == stopCount) {
                    ...
                    if (lastCharWritten == 0x1) {
                        ...
                        stopCount = 10000;
                        if (command != null && command[0] === '\r') {
                            console.log("returning nextinstr");
                        }
                        return false;
                    }
                }
